 ...
 *  @private                                                                                            // 92
 *  @param {Object} stores - The stores object from the FS.Collection options                           // 93
 *                                                                                                      // 94
 ...
 */                                                                                                     // 161
var makeSafeCallback = function (callback) {                                                            // 162
    // Make callback safe for Meteor code                                                               // 163
    return Meteor.bindEnvironment(callback, function(err) { throw err; });                              // 164
};                                                                                                      // 165
                                                                                                        // 166
function saveCopy(fsFile, storeName, options) {                                                         // 167
  options = options || {};                                                                              // 168
                                                                                                        // 169
  var storage = FS.StorageAdapter(storeName);                                                           // 170
  if (!storage) {                                                                                       // 171
    throw new Error('No store named "' + storeName + '" exists');                                       // 172
  }                                                                                                     // 173
                                                                                                        // 174
  FS.debug && console.log('saving to store ' + storeName);                                              // 175
                                                                                                        // 176
  var writeStream = storage.adapter.createWriteStream(fsFile);                                          // 177
  var readStream = FS.TempStore.createReadStream(fsFile);                                               // 178
                                                                                                        // 179
  // Pipe the temp data into the storage adapter                                                        // 180
  readStream.pipe(writeStream);                                                                         // 181
}                                                                                                       // 182
                                                                                                        // 183
//////////////////////////////////////////////////////////////////////////////////////////////////////////
